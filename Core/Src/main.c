...
__weak void led_func(void *argument)
{
...
/* USER CODE BEGIN Header_buzzer_func */
/**
* @brief Function implementing the BUZZER_TASK thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_buzzer_func */
__weak void buzzer_func(void *argument)
{
  /* USER CODE BEGIN buzzer_func */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
...
/* USER CODE BEGIN Header_alarm_func */
/**
* @brief Function implementing the ALARM_TASK thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_alarm_func */
__weak void alarm_func(void *argument)
{
